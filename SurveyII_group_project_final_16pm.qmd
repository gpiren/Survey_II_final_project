...
test_model <- glm(qc19_numeric ~ country_name + qc20 + qc15_1 + qc15_2 + qc15_3 + 
                    qc17_3 + qc17_4 + qc18_2 + qc18_3 + qc1_4 + qc4_7 + qc4_8 + 
                    qc5_3 + d11 + d15a + d15b + d60 + qa1 + qa14 + d10,
...
No variable must be removed based on VIF, as all adjusted GVIF values are \< 2.
